...
// MockDataAggregator is a mock of DataAggregator interface.
type MockDataAggregator struct {
	ctrl     *gomock.Controller
	recorder *MockDataAggregatorMockRecorder
}

// MockDataAggregatorMockRecorder is the mock recorder for MockDataAggregator.
type MockDataAggregatorMockRecorder struct {
	mock *MockDataAggregator
}

// NewMockDataAggregator creates a new mock instance.
func NewMockDataAggregator(ctrl *gomock.Controller) *MockDataAggregator {
	mock := &MockDataAggregator{ctrl: ctrl}
	mock.recorder = &MockDataAggregatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDataAggregator) EXPECT() *MockDataAggregatorMockRecorder {
	return m.recorder
}

// Aggregate mocks base method.
func (m *MockDataAggregator) Aggregate(info model.PluginInfo) (model.AggregatorInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Aggregate", info)
	ret0, _ := ret[0].(model.AggregatorInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Aggregate indicates an expected call of Aggregate.
func (mr *MockDataAggregatorMockRecorder) Aggregate(info interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Aggregate", reflect.TypeOf((*MockDataAggregator)(nil).Aggregate), info)
}
...
func (m *MockDataPreparer) PrepareData(pluginInfo model.PluginInfo, aggregatorInfo model.AggregatorInfo) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrepareData", pluginInfo, aggregatorInfo)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDataPreparerMockRecorder) PrepareData(pluginInfo, aggregatorInfo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PrepareData", reflect.TypeOf((*MockDataPreparer)(nil).PrepareData), pluginInfo, aggregatorInfo)
}
