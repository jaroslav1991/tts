...
send-test-event:
	go run ./cmd/cli/main.go -d '{"pluginType":"jetbrains","pluginVersion":"1.0.0","cliType":"windowsOS","cliVersion":"1.1.0","ideType":"intellij idea","ideVersion":"2.1.1","events":[{"createdAt":"2022-01-1114:23:01","type":"modifyfile","project":"someproject","projectBaseDir":"./","language":"golang","target":"C/Projects/Golang/cli-tts","timezone":"12345"}]}'
